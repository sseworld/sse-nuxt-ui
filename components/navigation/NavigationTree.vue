<template>
    <nav v-if="groups?.length" :class="ui.wrapper" v-bind="attrs">
        <template v-for="(group, index) in groups" :key="index">
            <UNavigationAccordion v-if="group.type === 'accordion'" :links="group.children" :level="level"
                :multiple="multiple" :default-open="defaultOpen" :ui="{ ...ui.accordion, links: ui.links }" />
