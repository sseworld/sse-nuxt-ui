    ...
    <UCard :class="ui.wrapper" v-bind="attrs" :ui="ui">
        <div>
            ...
            <div v-if="author" :class="ui.author.wrapper">
                <UAvatar v-if="author.avatar" :alt="author.name"
                    v-bind="{ size: ui.author.avatar.size, ...author.avatar }" :class="ui.author.avatar.base" />

                <div>
                    <NuxtLink v-if="author.to" :aria-label="author.name" v-bind="getNuxtLinkProps(author)"
