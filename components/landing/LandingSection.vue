<template>
    <div :class="ui.wrapper" v-bind="attrs">
        ...
        <UContainer :class="ui.container">
            <div v-if="(icon || $slots.icon) || (headline || $slots.headline) || (title || $slots.title) || (description || $slots.description) || (links?.length || $slots.links)"
                :class="ui.base">
                ...
                <dl v-if="align !== 'center' && features?.length"
                    ...
                    <div v-for="feature in features" :key="feature.name" :class="ui.features.base">
                        <dt :class="ui.features.name">
                            <UIcon :name="feature.icon || ui.features.icon.name" :class="ui.features.icon.base"
                                aria-hidden="true" />
            ...
            <div v-if="align === 'center' && (links?.length || $slots.links)"
