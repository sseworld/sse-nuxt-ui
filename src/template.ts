    ...
    for (const component in theme) {
      templates.push({
        ...
        getContents: async () => {
          ...
          if (
            result?.defaultVariants?.color &&
            uiOptions.theme?.defaultVariants?.color
          ) {
            result.defaultVariants.color =
              uiOptions.theme.defaultVariants.color;
          }
          if (
            result?.defaultVariants?.size &&
            uiOptions.theme?.defaultVariants?.size
          ) {
