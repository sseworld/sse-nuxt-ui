...
import theme from "#build/sse-ui/auth-form";
import type {
  ButtonProps,
  FormProps,
  FormFieldProps,
...
export interface AuthFormProps<
  T extends FormSchema = FormSchema<object>,
  F extends AuthFormField = AuthFormField,
> {
  /**
...
> = Record<string, (props: SlotProps) => any> &
  Record<
    `${keyof T extends string ? keyof T : never}-field`,
    (props: SlotProps) => any
  >;

type DynamicFormFieldSlots<T> = Record<string, (props?: {}) => any> &
  Record<
  ...
  >
    ...
    <div :class="ui.body({ class: props.ui?.body })">
      <div
        ...
        :class="ui.providers({ class: props.ui?.providers })"
      >
        <slot name="providers">
          <UButton
      ...
      <USeparator
        ...
        v-bind="
          typeof separator === 'object' ? separator : { label: separator }
        "
            ...
            >
              <template #trailing>
                <UButton
                  ...
                  :icon="
                    passwordVisibility
                      ? appConfig.ui.icons.eyeOff
                      : appConfig.ui.icons.eye
                  "
                  :aria-label="
                    passwordVisibility
