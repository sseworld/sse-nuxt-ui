<template>
    <UModal v-model="isOpen" :overlay="!smallerThanSm" :transition="!smallerThanSm" :ui="ui">
        <UCommandPalette ref="commandPaletteRef" :model-value="[]" :groups="groups" :ui="ui.commandPalette"
            :close-button="ui.default.closeButton" :fuse="fuse" multiple v-bind="attrs" @update:model-value="onSelect"
            @close="isOpen = false">
