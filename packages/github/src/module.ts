...
export default defineNuxtModule<ModuleOptions>({
  ...
  setup(options, nuxt) {
    ...
    if (!nuxt.options.runtimeConfig.public) {
      nuxt.options.runtimeConfig.public = {} as PublicRuntimeConfig;
    }
    ...
    // @ts-ignore
    nuxt.options.runtimeConfig.public.github = defu(
      nuxt.options.runtimeConfig.public.github,
      config
    );
    // @ts-ignore
    nuxt.options.runtimeConfig.github = defu(
    ...
    if (options.remarkPlugin) {
      ...
      nuxt.hook("content:context", (context) => {
        ...
        if (!Array.isArray(context.markdown.remarkPlugins)) {
          context.markdown.remarkPlugins["remark-github"] = {
    ...
    addComponent({
      ...
      filePath: resolveModule("./components/GithubRepository", {
        paths: runtimeDir,
      }),
      global: true,
    });
    ...
    addComponent({
      name: "GithubReadme",
      filePath: resolveModule("./components/GithubReadme", {
        paths: runtimeDir,
      }),
      global: true,
    });
    ...
    if (options.releases) {
      ...
      nitroConfig.handlers.push({
        ...
        handler: resolveModule("./server/api/releases/index", {
          paths: runtimeDir,
        }),
      });
      ...
      addComponent({
        name: "GithubReleases",
        filePath: resolveModule("./components/GithubReleases", {
          paths: runtimeDir,
        }),
        global: true,
      });
      addComponent({
        ...
        filePath: resolveModule("./components/GithubLastRelease", {
          paths: runtimeDir,
        }),
        global: true,
      });
      addComponent({
        name: "GithubRelease",
        filePath: resolveModule("./components/GithubRelease", {
          paths: runtimeDir,
        }),
        global: true,
      });
    ...
    if (options.contributors) {
      nitroConfig.handlers.push({
        ...
        handler: resolveModule("./server/api/contributors", {
          paths: runtimeDir,
        }),
      });
      ...
      nitroConfig.handlers.push({
        ...
        handler: resolveModule("./server/api/contributors/file", {
          paths: runtimeDir,
        }),
      });
      ...
      addComponent({
        ...
        filePath: resolveModule("./components/GithubContributors", {
          paths: runtimeDir,
        }),
        global: true,
      });
      addComponent({
        ...
        filePath: resolveModule("./components/GithubFileContributors", {
          paths: runtimeDir,
        }),
        global: true,
      });
    ...
    addComponent({
      name: "GithubCommits",
      filePath: resolveModule("./components/GithubCommits", {
        paths: runtimeDir,
      }),
      global: true,
    });
