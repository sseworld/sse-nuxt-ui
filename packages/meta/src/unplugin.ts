...
type ComponentMetaUnpluginOptions = {
  parser?: ComponentMetaParser;
  parserOptions: ComponentMetaParserOptions;
};
    ...
    return {
      ...
      vite: {
        ...
        async handleHotUpdate({ file }) {
          if (
            Object.entries(instance.components).some(
              ([, comp]: any) => comp.fullPath === file
            )
          ) {
